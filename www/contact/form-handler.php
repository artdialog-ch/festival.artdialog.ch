...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = '<div style="text-align: center; color: #fff; margin: 0; padding: 100px 0; height: 100%; width: 100%; background: #202121;">Danke! Ihre Meldung wurde erfolgreich übermittelt.</div>';
